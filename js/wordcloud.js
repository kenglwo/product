...
d3.csv("rsc\\recipe1_review.csv", function(data){
d3.csv("rsc\\recipe1_texture.csv", function(data2){
d3.csv("rsc\\recipe2_review.csv", function(recipe2_review){
d3.csv("rsc\\recipe2_texture.csv", function(recipe2_texture){
