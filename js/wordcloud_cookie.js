d3.csv("rsc\\cookie1_review.csv", function(data){
d3.csv("rsc\\cookie1_texture.csv", function(data2){
d3.csv("rsc\\cookie2_review.csv", function(recipe2_review){
d3.csv("rsc\\cookie2_texture.csv", function(recipe2_texture){
